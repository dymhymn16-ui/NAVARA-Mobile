...
public:
    ...
    {
        m_input = string;
        m_caption = Encoding::cp2utf(string);
        updateCommandSuggestions();
    }
...
private:
    ...
    std::vector<Button*> m_commandButtons;

    int m_commandScroll = 0;

    float m_commandTouchStartX = 0.0f;
    float m_commandTouchCurrentX = 0.0f;

    bool m_commandDragging = false;
...
public:
    ...
    public:
        ...
        public:
            ...
            void setLangMode(bool isEngMode)
            {
                m_isEngMode = isEngMode;
            }

        private:
            ExtendedKey m_extendedKey;
            char m_value;
            bool m_isEngMode = true;
        };

        KeyboardLayout::Row::Key* addKey(
...
public:
    ...
    KeyboardInput* input() const
    {
        return m_input;
    }

    KeyboardHistory* history() const
    {
        return m_history;
    }
